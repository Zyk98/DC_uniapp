				...
				<view class="uni-uploader__files">
					<block v-for="(image,index) in imageList" :key="index">
						<view class="uni-uploader__file position-relative">
							...
							<view class="position-absolute top-0 right-0 rounded" style="padding: 0 10rpx;background-color: rgba(0,0,0,0.5);" @click.stop="deleteImage(index)">
								<text class="iconfont icon--zan text-white"></text>
							</view>
						</view>
					</block>
